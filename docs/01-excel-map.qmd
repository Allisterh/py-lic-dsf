...
| New MLT portfolio (after load) | `external.portfolio` | [`baseline_dsa`](https://github.com/Teal-Insights/py-lic-dsf/blob/main/demo/baseline_dsa.ipynb) |
| `Dom_Debt_Data` / indicators | `load_domestic` → `DomesticDebtBook` | — |
...
| Output 2 / 3 | `output_31_table`, `output_32_table` | [`stress_dsa`](https://github.com/Teal-Insights/py-lic-dsf/blob/main/demo/stress_dsa.ipynb) |
...
| CI / Trigger / Input 1 market | `load_rating` | [`output_5`](https://github.com/Teal-Insights/py-lic-dsf/blob/main/demo/output_5.ipynb) |
| Chart Data / Output 5 | `ChartDataRegistry`, `moderate_panel`, `market_panel` | [`output_5`](https://github.com/Teal-Insights/py-lic-dsf/blob/main/demo/output_5.ipynb) |
...
| Output 7 risk summary | `risk_summary_panel` | [`output_7`](https://github.com/Teal-Insights/py-lic-dsf/blob/main/demo/output_7.ipynb) |
